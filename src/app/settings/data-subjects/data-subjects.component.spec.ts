...
describe('DataSubjectsComponent', () => {
  let component: DataSubjectsComponent;
  let fixture: ComponentFixture<DataSubjectsComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [DataSubjectsComponent],
      imports: [
        RouterTestingModule,
        PageWrapperModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DataSubjectsComponent);
